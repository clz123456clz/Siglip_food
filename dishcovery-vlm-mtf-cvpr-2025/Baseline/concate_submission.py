...
merge_csvs_with_offset("./results/siglip2gaint384_multi_baseline.csv", "./results/siglip2gaint384_single_baseline.csv", "./results/siglip2gaint384_submission_baseline.csv")